...
use crate::pb::runecraftstudios::pastello::game::{
    ...
    types::v1::PlayerId, 
    session::v1::GameSessionId, // FIX: Correct import for session ID
};
use anyhow::Result;
