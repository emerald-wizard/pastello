...
export const TriviaRules: MessageFns<TriviaRules> = {
  encode(message: TriviaRules, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.negativeMarking !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TriviaRules {
