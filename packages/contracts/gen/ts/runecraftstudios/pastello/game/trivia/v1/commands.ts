...
export const SubmitAnswerCommand: MessageFns<SubmitAnswerCommand> = {
  encode(message: SubmitAnswerCommand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubmitAnswerCommand {
...
export const RevealHintCommand: MessageFns<RevealHintCommand> = {
  encode(message: RevealHintCommand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== undefined) {
      GameSessionId.encode(message.sessionId, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RevealHintCommand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AnswerAcceptedEvent: MessageFns<AnswerAcceptedEvent> = {
  encode(message: AnswerAcceptedEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== undefined) {
      GameSessionId.encode(message.sessionId, writer.uint32(10).fork()).join();
    }
    if (message.playerId !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AnswerAcceptedEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const HintRevealedEvent: MessageFns<HintRevealedEvent> = {
  encode(message: HintRevealedEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== undefined) {
      GameSessionId.encode(message.sessionId, writer.uint32(10).fork()).join();
    }
    if (message.hintText !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HintRevealedEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
